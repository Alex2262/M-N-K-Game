...
class MainAiV2:
    ...
    def iterative_deepening(self, board, plr):
        ...
        for running_depth in range(1, self.max_depth + 1):
            ...
            returned = self.negamax(np_board, plr, MIN, MAX, self.curr_depth+1)
    ...
    def negamax(self, board, plr, alpha, beta, depth):
        ...
        for move in moves:
            ...
            returned = self.negamax(board, 2 if plr == 1 else 1, -beta, -alpha, depth-1)
